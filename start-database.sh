...
DB_CONTAINER_NAME="saasify-mysql"
...
docker run --name $DB_CONTAINER_NAME -e MYSQL_ROOT_PASSWORD=$DB_PASSWORD -e MYSQL_DATABASE=saasify -d -p 3306:3306 docker.io/mysql
